...
- 한국 주소를 더 자연스럽게 한글화
- 기본 역지오코딩은 **VWORLD API** 기준으로 처리
- **건물명 보강은 env 설정으로 on/off 가능**하며, 필요할 때만 Naver API 사용
...
- Latest: [v1.2.0](https://github.com/lscya84/immich-naver-reverse-geocoding/releases/tag/v1.2.0)
- Previous: [v1.1.0](https://github.com/lscya84/immich-naver-reverse-geocoding/releases/tag/v1.1.0)
...
건물명을 `city` 뒤에 `(건물명)` 형태로 보강하고 싶을 때만 사용합니다. `APPEND_BUILDING_NAME=false`면 Naver API를 호출하지 않습니다.
